...
echo AZURE_CLIENT_ID=30481a8b-2c02-486d-b773-b1ad4f8f4bbe >> .env
echo AZURE_CLIENT_SECRET=vik8Q~GVXB_mlUsujOENla.ebEb2FlqQ0OiEccnu >> .env
echo AZURE_TENANT_ID=79398827-dad5-4378-ac02-4d0f46965838 >> .env
